		...
		<div class="container">
			...
			<div class="col-md-10" >
				...
				<th><span style="color:#6e6e6e;">Action</span></th>
					...
					<%
                                    ArrayList<ReportBean> alist=new ArrayList<ReportBean>();
                                    alist = new ReportDao().showAllReportsByEmail(email);
                                    if(alist!=null)
                                    {
                                        for(int i=0;i<alist.size();i++)
                                        {
                                            String paperName= new PaperCategoryDao().paperCategoryByid(alist.get(i).getCatid());
					...
					<tr>
						...
						<td>
							<span style="color:#6e6e6e;">
							<%= alist.get(i).getTotalq() %>
							</span>
						</td>
						<td>
							<span style="color:#6e6e6e;">
							<%= alist.get(i).getCorrectans() %>
							</span>
						</td>
						
						<td>
							<span style="color:#6e6e6e;">
							<a href="reports.jsp?reportid=<%= alist.get(i).getReportid() %>">View Result</a>
							</span>
						</td>
